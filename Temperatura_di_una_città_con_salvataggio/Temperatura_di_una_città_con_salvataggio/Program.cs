 ...
 * con modifiche alla comunicazione verso l'esterno (solo dal main). */
...
namespace Temperatura_di_una_citta
{
    ...
    class Program
    {
        ...
        {
            StreamWriter sw = new StreamWriter(AppDomain.CurrentDomain.BaseDirectory + @"Dati.txt"); //Inizializzaione della scrittura sul file.
            int valore = 1;
            ...
            Console.WriteLine(c.ToString()); //Stampa la stringa restituita dal Metodo ToString della classe temperatura.
            sw.Write(c.ToString()); //Scrive su file la stringa restituita dal Metodo ToString della classe temperatura.
            sw.Close(); //Chiusura file.
        }
    }
}